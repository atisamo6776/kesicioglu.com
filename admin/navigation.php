                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 8px;">
                                    ...
                                    <a href="?action=toggle&id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline" title="Durumu Değiştir">
                                        <i class="fas fa-power-off"></i>
                                    </a>
                                    <a href="?action=delete&id=<?php echo $item['id']; ?>" class="btn btn-sm btn-danger" title="Sil" onclick="return confirm('Bu menü öğesini silmek istediğinize emin misiniz?');">
